...
class ReadDevicesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_read_devices)
    ...
    private val scanCallback = object : ScanCallback() {
        ...
        override fun onScanFailed(errorCode: Int) {
            Toast.makeText(this@ReadDevicesActivity, "Scan failed with error: $errorCode", Toast.LENGTH_SHORT).show()
            isScanning = false
        }
    }
